  ...
  return (
    <div className={`kompas ${collapsed ? 'kompas--collapsed' : ''}`}>
      <div className="kompas-header">
        ...
        >
          <svg className="kompas-title-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          {/* Chevron in zelfde stijl als andere section-titels: SVG, uiterst
              rechts, roteert via .is-collapsed class. */}
          <span className={`card-section-title-chevron ${collapsed ? 'is-flipped' : ''}`} aria-hidden="true">
